...
- `apps/analysis.cpp` — консольная утилита для проведения полного эксперимента и сохранения результатов в `results/measurements.csv`.
- `apps/a2i.cpp` — решение подзадачи A2i (гибридная сортировка с порогом 15) для отправки на Codeforces.
...
```
На стандартный ввод необходимо подать длину массива (до 10⁶) и значения элементов. Программа выводит отсортированный массив, используя гибрид MERGE+INSERTION с фиксированным порогом 15.
